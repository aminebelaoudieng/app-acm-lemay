<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <strong><?php echo e(__('fiches_subtabs.file_name')); ?></strong>
            <?php echo Form::text('name', (isset($annexe->name))? $annexe->name:'', array('class' => 'form-control')); ?>

        </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <strong><?php echo e(__('fiches_subtabs.file')); ?></strong>
            ...
            <div class="custom-file-wrapper">
                ...
                <span class="file-name ml-3" id="annexe_file_filename"><?php echo e(__('profile.no_file_selected')); ?></span>
            </div>

            <script>
                document.getElementById('annexe_file').addEventListener('change', function(e) {
                        const file = e.target.files[0];
                        const fileName = file ? file.name : '<?php echo e(__("profile.no_file_selected")); ?>';
                        ...
                        if (file) {
                            ...
                            if (!isPdf) {
                                if (!pdfNotice) {
                                    ...
                                    span.textContent = '<?php echo e(__('fiches_subtabs.only_pdf_allowed')); ?>';
                                    e.target.parentNode.appendChild(span);
                                } else {
                                    pdfNotice.textContent = '<?php echo e(__('fiches_subtabs.only_pdf_allowed')); ?>';
                                }
                            } else {
                ...
                (function(){
                    ...
                    form.addEventListener('submit', function(e){
                        ...
                        if (!fileInput.files || fileInput.files.length === 0) {
                            alert('<?php echo e(__('fiches_subtabs.file_required', [], app()->getLocale())); ?>');
                            return;
                        }
                        ...
                        xhr.onload = function() {
                            if (xhr.status >= 200 && xhr.status < 300) {
                                ...
                                if (data.success) {
                                    ...
                                    setTimeout(function(){ location.href = '<?php echo e(route('fiches.edit', $ficheMaster->id)); ?>#annexe'; }, 900);
                                } else {
            ...
            <?php if(isset($annexe->file)): ?>
            <a href="<?php echo e((isset($annexe->file))? $annexe->fileLink:''); ?>" target="_blank"><?php echo e(__('fiches_subtabs.download_file')); ?></a>
            <?php endif; ?>  
            <sup><?php echo __('fiches_subtabs.compress_advice', ['url' => 'https://www.ilovepdf.com/compress_pdf']); ?></sup>

        </div>
    </div>


</div><?php /**PATH /home/lemaycon/app.lemayconsulting.com/resources/views/users/fiches/sub-tabs/annexe.blade.php ENDPATH**/ ?>