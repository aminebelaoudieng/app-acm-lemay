...
<div class="list-page">
    ...
    <table class="bg-grey" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td class="main-label"><?php echo __('pdf.price_per_sqft_requested'); ?>*</td>
            <td class="info-fiche">-</td>
            <?php $__currentLoopData = $ficheMaster->fichesVigueur()->limit(4)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fiche): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <table>
        <tr>
            ...
            <td>
                ...
                <p class="probablite"><?php echo e(__('pdf.probable_sale_price_7_of_10', ['min' => money($ficheMaster->moyenneRatioPrixHabitableVigueur*0.95), 'max' => money($ficheMaster->moyenneRatioPrixHabitableVigueur*1.05)])); ?></p>

                <?php else: ?>
                <p class="table-title" style="font-size:12px;"><?php echo e(__('pdf.probable_listing_price_sale')); ?></p>
                <p class="probablite"><?php echo e(__('pdf.probable_sale_price_7_of_10', ['min' => money($ficheMaster->moyennePrixDemande*0.95), 'max' => money($ficheMaster->moyennePrixDemande*1.05)])); ?></p>

                <?php endif; ?>
            </td>
        </tr>
    </table>
</div><?php /**PATH /home/lemaycon/app.lemayconsulting.com/resources/views/users/fiches/pdf/pages-plex/list-vigueur.blade.php ENDPATH**/ ?>