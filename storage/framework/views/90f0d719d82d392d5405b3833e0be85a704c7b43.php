...
<?php echo Form::open(array('route' => 'fiches.store', 'files' => true, 'method'=>'POST')); ?>

<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <strong><?php echo e(__('fiches_form.address_full')); ?></strong>
            <?php echo Form::text('adresse', null, array('class' => 'form-control','id'=>'googleAutoComplete','placeholder' => __('fiches_form.address_placeholder'))); ?>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <strong><?php echo e(__('fiches_form.category')); ?></strong>
            <select name="categorie" class="form-control">
                <?php $__currentLoopData = Config::get('datas.categories'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($cat['key']); ?>"><?php echo e(__('datas.categories.' . $cat['key'])); ?></option>
    ...
    <div class="col-xs-12 col-sm-12 col-md-6">
        <div class="form-group">
            ...
            <?php echo Form::hidden('map_lat',null, array('class' => 'hidden','id'=>'map_lat')); ?>

            <?php echo Form::hidden('map_lng', null, array('class' => 'hidden','id'=>'map_lng')); ?>

            <?php echo Form::hidden('map_zoom', null, array('class' => 'hidden','id'=>'map_zoom')); ?>
    ...
    <div class="col-xs-12 col-sm-12 col-md-6">
        <div class="form-group">
            ...
            <?php echo Form::hidden('street_lat', null, array('class' => 'hidden','id'=>'street_lat')); ?>

            <?php echo Form::hidden('street_lng', null, array('class' => 'hidden','id'=>'street_lng')); ?>

            <?php echo Form::hidden('street_heading', null, array('class' => 'hidden','id'=>'street_heading')); ?>

            <?php echo Form::hidden('street_pitch', null, array('class' => 'hidden','id'=>'street_pitch')); ?>

            <?php echo Form::hidden('street_zoom', null, array('class' => 'hidden','id'=>'street_zoom')); ?>


        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                <button type="submit" class="btn btn-success float-right"><?php echo e(__('fiches_form.save')); ?></button>
            </div>
        </div>
        <?php echo Form::close(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lemaycon/app.lemayconsulting.com/resources/views/users/fiches/create.blade.php ENDPATH**/ ?>