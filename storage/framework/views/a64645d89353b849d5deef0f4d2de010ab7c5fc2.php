...
<div class="tab-content p-5" id="mainContent">
    ...
    <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
        <?php echo Form::model($ficheMaster, ['method' => 'POST', 'files' => true, 'route' => ['fiches.vigueur.store',$ficheMaster->id],'class'=>'row']); ?>
        ...
        <div class="col-xs-12 col-sm-12 col-md-2">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <a class="nav-link" id="v-pills-prixdate-tab" data-toggle="pill" href="#v-pills-prixdate" role="tab" aria-controls="v-pills-prixdate" aria-selected="false"><?php echo e(__('fiches_form.suggested_price')); ?></a>
        ...
        <div class="col-xs-12 col-sm-12 col-md-10">
            <div class="tab-content" id="v-pills-tabContent">
                ...
                <h2><?php echo e(__('fiches_form.new_current_property')); ?></h2>
                ...
                <div class="tab-pane fade" id="v-pills-prixdate" role="tabpanel" aria-labelledby="v-pills-prixdate-tab">
                    <?php echo $__env->make('users.fiches.sub-tabs.prix-date-vigueur',['fiche'=>null], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lemaycon/app.lemayconsulting.com/resources/views/users/fiches/vigueur/create.blade.php ENDPATH**/ ?>