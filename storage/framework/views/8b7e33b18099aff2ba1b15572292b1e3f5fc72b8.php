...
<div class="courtier-page resume">
    ...
    <?php if(!$ficheMaster->ne_pas_afficher_les_vigueurs): ?>      
     <h1 class="upper"><?php echo e(__('pdf.resume_vigueur.title')); ?></h1>
    ...
    <div class="texte">
        ...
        <p>
            ...
            <?php echo __('pdf.avg_days_on_market_text', ['value' => '<span class="txt-color">' . $ficheMaster->moyenneJoursVigueur . '</span>']); ?>
...
</div><?php /**PATH /home/lemaycon/app.lemayconsulting.com/resources/views/users/fiches/pdf/pages-plex/resume-vigueur.blade.php ENDPATH**/ ?>