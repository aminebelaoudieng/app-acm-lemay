...
<div class="list-page">
    <h1 class="txt-center upper page-title"><?php echo e(__('pdf.list_vendu_title')); ?></h1>
    <h2 class="txt-center upper page-sub-title"><?php echo e(__('pdf.list_vendu_subtitle')); ?></h2>
    ...
    <table class="bg-grey" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <?php $__currentLoopData = $ficheMaster->fichesVendu()->limit(4)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fiche): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <td class="info-fiche"><?php if(($fiche->type_copropriete=="divise")): ?> <?php echo e(money($fiche->comparable_vendu_prix_evaluation)); ?> <?php endif; ?></td>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tr>
        <?php endif; ?>
        <tr>
        ...
        <tr>
            ...
            <td class="info-fiche">-</td>
            <?php $__currentLoopData = $ficheMaster->fichesVendu()->limit(4)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fiche): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <td class="info-fiche"><?php echo e($fiche->comparable_vendu_delais_vente); ?> <?php echo e(__('pdf.days')); ?> </td>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tr>
        <tr>
    ...
    <sup class="txt-center" style="margin-top:-20px;"><?php echo e(__('pdf.price_sqft_note')); ?></sup>
    <table>
        <tr>
            <td>
            ...
            <td>
                ...
                <p class="probablite"><?php echo e(__('pdf.probable_sale_price_range_sqft', ['min' => money($ficheMaster->moyenneRatioPrixHabitableVendu*0.95), 'max' => money($ficheMaster->moyenneRatioPrixHabitableVendu*1.05)])); ?></p>

                <?php else: ?>
                <p class="table-title" style="font-size:12px;"><?php echo e(__('pdf.probable_listing_price_requested')); ?></p>
                <p class="probablite"><?php echo e(__('pdf.probable_sale_price_range_requested', ['min' => money($ficheMaster->moyennePrixVente*0.95), 'max' => money($ficheMaster->moyennePrixVente*1.05)])); ?></p>
                <?php endif; ?>
            </td>
        </tr>
    </table>
</div><?php /**PATH /home/lemaycon/app.lemayconsulting.com/resources/views/users/fiches/pdf/pages-condo/list-vendu.blade.php ENDPATH**/ ?>