...
<div class="sujet-page">
    <h1 class="txt-center upper page-title"><?php echo e(__('pdf.sujet.title')); ?></h1>
                    ...
                    <tr>
                        <td>
                            <p class="table-title geo-title">
                                <?php echo e(__('pdf.sujet.geolocation')); ?>
                    ...
                    <tr class="tr-top">
                        <td>
                            <p class="table-title center mt">
                                <?php echo e(__('pdf.sujet.municipal_eval')); ?>
                    ...
                    <tr>
                        <td>
                            <table class="bg-grey" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.sujet.role_year')); ?></td>
                                    <td class="valeur"><?php echo e($fiche->annee_role); ?></td>
                                </tr>
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.sujet.land_eval')); ?></td>
                                    <td class="valeur"><?php echo e(money($fiche->evaluation_terrain)); ?></td>
                                </tr>
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.sujet.building_eval')); ?></td>
                                    <td class="valeur"><?php echo e(money($fiche->evaluation_batiment)); ?></td>
                                </tr>
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.sujet.total_eval')); ?></td>
                    ...
                    <tr class="tr-top">
                        <td>
                            <p class="table-title center">
                                <?php echo e(__('pdf.sujet.characteristics')); ?>
                    ...
                    <tr>
                        <td>
                            <table class="bg-grey" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.sujet.parking')); ?></td>
                                    <td class="valeur">
                                        <?php echo e($fiche->caracteristique_stationnement); ?></td>
                                </tr>
                                <?php endif; ?>

                                <?php if($fiche->caracteristique_garage>0): ?>
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.sujet.garage')); ?></td>
                                    <td class="valeur">
                                        <?php echo e($fiche->caracteristique_garage); ?></td>
                                </tr>
                                <?php endif; ?>
                                
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.sujet.num_rooms')); ?></td>
                                    <td class="valeur"><?php echo e($fiche->caracteristique_nombre_piece); ?></td>
                                </tr>
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.sujet.num_bedrooms')); ?></td>
                                    <td class="valeur"><?php echo e($fiche->caracteristique_nombre_chambre); ?></td>
                                </tr>
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.sujet.num_bathrooms')); ?></td>
                                    <td class="valeur"><?php echo e($fiche->caracteristique_nombre_salle_de_bain); ?></td>
                                </tr>
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.sujet.num_powder_rooms')); ?></td>
                                    <td class="valeur"><?php echo e($fiche->caracteristique_nombre_salle_eau ? $fiche->caracteristique_nombre_salle_eau : __('pdf.sujet.none')); ?></td>
                                </tr>

                                <tr>
                                    <td class="label"><?php echo e($fiche->caracteristique_type_propriete=="condo" ? __('pdf.sujet.floor') : __('pdf.sujet.floors')); ?></td>
...
</div><?php /**PATH /home/lemaycon/app.lemayconsulting.com/resources/views/users/fiches/pdf/pages-unifamiliale/sujet.blade.php ENDPATH**/ ?>