...
<div class="sub-sujet-page sujet-page">
    <h1 class="upper"><span class="index line-color txt-white"><?php echo e($nb); ?> </span><?php echo e(__('pdf.vendu.title')); ?></h1>
                    ...
                    <tr>
                        <td>
                            <table class="details-vente bg-grey" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.vendu.municipal_eval')); ?></td>
                                    <td><?php echo e(money($fiche->comparable_vendu_prix_evaluation)); ?></td>
                                </tr>
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.vendu.asked_price')); ?></td>
                                    <td><?php echo e(money($fiche->comparable_vendu_prix_demande)); ?></td>
                                </tr>
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.vendu.sold_price')); ?></td>
                                    <td><?php echo e(money($fiche->comparable_vendu_prix_vente)); ?></td>
                                </tr>
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.vendu.sale_date')); ?></td>
                                    <td><?php echo e(($fiche->comparable_vendu_date_vente)); ?></td>
                                </tr>
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.vendu.sale_delay')); ?></td>
                    ...
                    <tr class="tr-top">
                        <td>
                            <p class="table-title center">
                                <?php echo e(__('pdf.vendu.characteristics')); ?>
                    ...
                    <tr>
                        <td>
                            <table class="bg-grey" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.vendu.property_type')); ?></td>
                                    <td>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                ...
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.vendu.building_type')); ?></td>
                                    <td>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                ...
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.vendu.construction_year')); ?></td>
                                    <td>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                ...
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.vendu.land_area')); ?></td>
                                    <td>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                ...
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.vendu.living_area')); ?></td>
                                    <td>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                ...
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.vendu.num_rooms')); ?></td>
                                    <td>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                ...
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.vendu.num_bedrooms')); ?></td>
                                    <td>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                ...
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.vendu.num_bathrooms')); ?></td>
                                    <td>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                ...
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.vendu.num_powder_rooms')); ?></td>
                                    <td>
                                        <table cellpadding="0" cellspacing="0">
                                        <tr>
                                ...
                                <tr>
                                    <td class="label"><?php echo e(($ficheMaster->caracteristique_type_propriete=="condo")?__('pdf.vendu.floor'):__('pdf.vendu.floors')); ?>: </td>
                                    <td>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                ...
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.vendu.parking')); ?></td>
                                ...
                                <tr>
                                    <td class="label"><?php echo e(__('pdf.vendu.garage')); ?></td>
        ...
        <tr>
            <td>
                <p class="table-title no-border">
                    <?php echo e(__('pdf.vendu.sale_price_ratios')); ?>
        ...
        <tr>
            <td>
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <td>
                            <?php echo e(__('pdf.vendu.ratio_sale_asked')); ?>

                        </td>
                        <td class="middle">
                            <?php echo e(__('pdf.vendu.ratio_sale_eval')); ?>
            ...
            <td>
                <table class="geolocalisation full-width" cellpadding="0" cellspacing="0">
                    <tr class="tr-top">
                        <td>
                            <p class="table-title no-border">
                                <?php echo e(__('pdf.vendu.geolocation')); ?>
...
</div><?php /**PATH /home/lemaycon/app.lemayconsulting.com/resources/views/users/fiches/pdf/pages-unifamiliale/vendu.blade.php ENDPATH**/ ?>