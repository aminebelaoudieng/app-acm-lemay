<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            <?php echo Form::open(['method' => 'DELETE','route' => ['fiches.destroy', $fiche->id],'style'=>'display:inline']); ?>
...
</div><?php /**PATH /home/lemaycon/app.lemayconsulting.com/resources/views/users/fiches/tabs/delete.blade.php ENDPATH**/ ?>