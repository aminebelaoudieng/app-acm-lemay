...
<div class="tab-content p-5" id="mainContent">
    ...
    <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
        <?php echo Form::model($annexe, ['files'=>true, 'method' => 'PATCH','route' => ['fiches.annexe.update',$ficheMaster->id, $annexe->id]]); ?>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-2">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link text-danger" id="v-pills-delete-tab" data-toggle="pill" href="#v-pills-delete" role="tab" aria-controls="v-pills-delete" aria-selected="false"><?php echo e(__('fiches_form.delete')); ?></a>
            ...
            <div class="col-xs-12 col-sm-12 col-md-10">
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <h2><?php echo e(__('fiches_form.edit_annex')); ?></h2>
                    <div class="tab-pane fade show active" id="v-pills-fichier" role="tabpanel" aria-labelledby="v-pills-fichier-tab">
                        <?php echo $__env->make('users.fiches.sub-tabs.annexe',['annexe'=>$annexe], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <?php echo Form::close(); ?>

                    <div class="tab-pane fade" id="v-pills-delete" role="tabpanel" aria-labelledby="v-pills-delete-tab">
                        <?php echo $__env->make('users.fiches.annexe.delete',['annexe'=>$annexe], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lemaycon/app.lemayconsulting.com/resources/views/users/fiches/annexe/edit.blade.php ENDPATH**/ ?>