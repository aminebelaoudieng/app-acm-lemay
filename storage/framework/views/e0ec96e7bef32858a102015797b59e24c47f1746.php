...
<head>
    ...
    <link href="<?php echo e(asset('css/app.css?v=4')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/custom-address-fix.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/login-modern.css')); ?>" rel="stylesheet">
...
<body>
    <div id="app">
        <?php if (! (request()->routeIs('login') || request()->is('/'))): ?>
                    ...
                    <ul class="navbar-nav ml-auto align-items-center">
                        <li class="nav-item">
                            <div class="lang-switch">
                                <button class="lang-option <?php echo e(app()->getLocale() == 'fr' ? 'active' : ''); ?>" onclick="changeLang('fr')">
                                    FR
                                </button>
                                <button class="lang-option <?php echo e(app()->getLocale() == 'en' ? 'active' : ''); ?>" onclick="changeLang('en')">
                                    EN
                                </button>
                            </div>
                        </li>
                                ...
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button"
                                   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    <img class="profil-icon"
                                         src="<?php echo e(isset(Auth::user()->photo) ? asset('uploads/users/'.Auth::user()->photo) : 'https://ui-avatars.com/api/?name='.urlencode(Auth::user()->name).'&background=ff0b17&color=fff&size=512&rounded=true&length=2'); ?>"
...
<?php /**PATH /home/lemaycon/app.lemayconsulting.com/resources/views/layouts/app.blade.php ENDPATH**/ ?>