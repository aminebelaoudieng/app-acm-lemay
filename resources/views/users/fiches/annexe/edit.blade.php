...
<div class="tab-content p-5" id="mainContent">
    ...
    <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
        {!! Form::model($annexe, ['files'=>true, 'method' => 'PATCH','route' => ['fiches.annexe.update',$ficheMaster->id, $annexe->id]]) !!}
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-2">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link text-danger" id="v-pills-delete-tab" data-toggle="pill" href="#v-pills-delete" role="tab" aria-controls="v-pills-delete" aria-selected="false">{{ __('fiches_form.delete') }}</a>
