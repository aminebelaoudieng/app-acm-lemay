...
<div class="sub-sujet-page sujet-page">
    <h1 class="upper"><span class="index line-color txt-white">{{ $nb }} </span>{{ __('pdf.vendu.title') }}</h1>
                    ...
                    <tr>
                        <td>
                            <table class="details-vente bg-grey" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="label">{{ __('pdf.vendu.municipal_eval') }}</td>
                                    <td>{{ money($fiche->comparable_vendu_prix_evaluation) }}</td>
                                </tr>
                                <tr>
                                    <td class="label">{{ __('pdf.vendu.asked_price') }}</td>
                                    <td>{{ money($fiche->comparable_vendu_prix_demande) }}</td>
                                </tr>
                                <tr>
                                    <td class="label">{{ __('pdf.vendu.sold_price') }}</td>
                                    <td>{{ money($fiche->comparable_vendu_prix_vente)  }}</td>
                                </tr>
                                <tr>
                                    <td class="label">{{ __('pdf.vendu.sale_date') }}</td>
                                    <td>{{ ($fiche->comparable_vendu_date_vente)  }}</td>
                                </tr>
                                <tr>
                                    <td class="label">{{ __('pdf.vendu.sale_delay') }}</td>
