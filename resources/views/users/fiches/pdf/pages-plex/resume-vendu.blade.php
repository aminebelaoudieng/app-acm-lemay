            ...
            <td>
                <table class="bg-grey" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td style="text-align:right;"><span class="txt-color">{{ money($ficheMaster->prixSelonEvaluation) }}</span></td>
                    </tr>
                    <tr>
                        <td>{{ __('pdf.based_on_price_per_sqft_living') }}</td>
                        <td style="text-align:right;"><span class="txt-color">{{ money($ficheMaster->prixSelonSuperficieHabitable) }}</span></td>
                    </tr>
                    <tr>
                        <td>{{ __('pdf.based_on_price_per_sqft_land') }}</td>
                        <td style="text-align:right;"><span class="txt-color">{{ money($ficheMaster->prixSelonSuperficieTerrain) }}</span></td>
                    </tr>
                    <tr>
                        <td>{{ __('pdf.based_on_avg_sale_price') }}</td>
                        <td style="text-align:right;"><span class="txt-color">{{ money($ficheMaster->moyennePrixVente) }}</span></td>
                    </tr>

                    <tr>
                        <td>{{ __('pdf.based_on_avg_mrb') }}</td>
                        <td style="text-align:right;"><span class="txt-color">{{ money($ficheMaster->prixSelonMRB) }}</span></td>
                    </tr>

                    <tr>
                        <td>{{ __('pdf.based_on_avg_mrn') }}</td>
                        <td style="text-align:right;"><span class="txt-color">{{ money($ficheMaster->prixSelonMRN) }}</span></td>
                    </tr>

                    <tr>
                        <td>{{ __('pdf.based_on_avg_cap_rate') }}</td>
                        <td style="text-align:right;"><span class="txt-color">{{ money($ficheMaster->prixSelonCAP) }}</span></td>
                    </tr>
                </table>
            </td>
        </tr>
