...
<div class="list-page">
    <h1 class="txt-center upper page-title">{{ __('pdf.list_vendu_title') }}</h1>
    <h2 class="txt-center upper page-sub-title">{{ __('pdf.list_vendu_subtitle') }}</h2>
    ...
    <table class="bg-grey" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td class="main-label">{{ __('pdf.vendu.sold_price') }}</td>
        ...
        <tr>
            <td class="main-label">{{ __('pdf.vendu.property_type') }}</td>
        ...
        <tr>
            <td class="main-label">{{ __('pdf.vendu.building_type') }}</td>
        ...
        <tr>
            <td class="main-label">{{ __('pdf.vendu.construction_year') }}</td>
        ...
        <tr>
            <td class="main-label">{{ __('pdf.vendu.living_area') }}</td>
        ...
        <tr>
            <td class="main-label">{{ __('pdf.vendu.num_bedrooms') }}</td>
        ...
        <tr>
            <td class="main-label">{{ __('pdf.sale_date') }}</td>
        ...
        <tr>
            <td class="main-label">{{ __('pdf.vendu.sale_delay') }}</td>
            <td class="info-fiche">-</td>
            @foreach($ficheMaster->fichesVendu()->limit(4)->get() as $fiche)
        ...
        <tr>
            <td class="main-label">{{ __('pdf.asked_price') }}</td>
            <td class="info-fiche">-</td>
            @foreach($ficheMaster->fichesVendu()->limit(4)->get() as $fiche)
        ...
        <tr>
            <td class="main-label">{{ __('pdf.sqft_according_sale_price') }}</td>
            <td class="info-fiche">-</td>
            @foreach($ficheMaster->fichesVendu()->limit(4)->get() as $fiche)
    ...
    <sup class="txt-center" style="margin-top:-20px;">{{ __('pdf.sqft_rate_note') }}</sup>
    <table>
        <tr>
            <td>
            ...
            <td>
                ...
                <p class="probablite">{!! __('pdf.probability_text_sqft', ['min' => money($ficheMaster->moyenneRatioPrixHabitableVendu*0.95), 'max' => money($ficheMaster->moyenneRatioPrixHabitableVendu*1.05)]) !!}</p>

                @else
                <p class="table-title" style="font-size:12px;">{{ __('pdf.probable_listing_price_asked') }}</p>
                <p class="probablite">{!! __('pdf.probability_text_asked', ['min' => money($ficheMaster->moyennePrixVente*0.95), 'max' => money($ficheMaster->moyennePrixVente*1.05)]) !!}</p>
                @endif
            </td>
        </tr>
    </table>
