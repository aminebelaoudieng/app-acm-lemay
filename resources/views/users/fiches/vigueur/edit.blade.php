...
<div class="tab-content p-5" id="mainContent">
    ...
    <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
        {!! Form::model($fiche, ['method' => 'PATCH', 'files' => true, 'route' => ['fiches.vigueur.update',$ficheMaster->id, $fiche->id]]) !!}
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-10">
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="v-pills-prixdate" role="tabpanel" aria-labelledby="v-pills-prixdate-tab">
                        @include('users.fiches.sub-tabs.prix-date-vigueur',['fiche'=>$fiche])
                    </div>
                    ...
                    <div class="tab-pane fade" id="v-pills-delete" role="tabpanel" aria-labelledby="v-pills-delete-tab">
                        @include('users.fiches.vigueur.delete',['fiche'=>$fiche])
                    </div>
                </div>
            </div>
        </div>
